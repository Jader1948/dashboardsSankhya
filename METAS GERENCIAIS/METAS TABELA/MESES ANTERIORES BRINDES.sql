SELECT 
	(CASE WHEN A.REFERENCIA_MES ='202301' THEN 'JANEIRO' 
		 WHEN A.REFERENCIA_MES ='202302' THEN 'FEVEREIRO' 
		 WHEN A.REFERENCIA_MES ='202303' THEN 'MARÇO' 
		 WHEN A.REFERENCIA_MES ='202304' THEN 'ABRIL' 
		 WHEN A.REFERENCIA_MES ='202305' THEN 'MAIO' 
		 WHEN A.REFERENCIA_MES ='202306' THEN 'JUNHO' 
		 WHEN A.REFERENCIA_MES ='202307' THEN 'JULHO' END) AS MES,
	A.FATURADO,
	A.META,
	A.PERCENTUAL
 FROM (
...
SELECT 
	(CASE WHEN W.SINAL_MES='JAN' THEN 'JANEIRO'
		...
		(CASE WHEN W.SINAL_MES='JAN' THEN STR(YEAR(GETDATE()), 4) + '01'
		WHEN W.SINAL_MES='FEV' THEN STR(YEAR(GETDATE()), 4) + '02'
		WHEN W.SINAL_MES='MAR' THEN STR(YEAR(GETDATE()), 4) + '03'
		WHEN W.SINAL_MES='ABR' THEN STR(YEAR(GETDATE()), 4) + '04'
		WHEN W.SINAL_MES='MAI' THEN STR(YEAR(GETDATE()), 4) + '05'
		WHEN W.SINAL_MES='JUN' THEN STR(YEAR(GETDATE()), 4) + '06'
		WHEN W.SINAL_MES='JUL' THEN STR(YEAR(GETDATE()), 4) + '07'
		WHEN W.SINAL_MES='AGO' THEN STR(YEAR(GETDATE()), 4) + '08'
		WHEN W.SINAL_MES='SET' THEN STR(YEAR(GETDATE()), 4) + '09'
		WHEN W.SINAL_MES='OUT' THEN STR(YEAR(GETDATE()), 4) + '10'
		WHEN W.SINAL_MES='NOV' THEN STR(YEAR(GETDATE()), 4) + '11'
		WHEN W.SINAL_MES='DEZ' THEN STR(YEAR(GETDATE()), 4) + '12' END)AS REFERENCIA_MES,
...
WHERE 
--LEFT(Convert(CHAR(8), MET.DTREF,112), 6) = STR(YEAR(GETDATE()), 4) + '01' 
VENDA IS NOT NULL  
--AND W.VENDA > 243000.00
...
WHERE LEFT(Convert(CHAR(6), A.REFERENCIA_MES,112), 6) < 

--STR(MONTH(GETDATE()), 4) +'05'

--STR(YEAR(GETDATE()), 4) + '04'


--A.REFERENCIA_MES BETWEEN '202301' AND '20320'