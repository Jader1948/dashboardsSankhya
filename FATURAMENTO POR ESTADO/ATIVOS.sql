...
SELECT  B.UF, COUNT(B.CODPARC)AS QDT_ATIVOS FROM (
...
SELECT  A.UF,
	...
	MAX (CONCAT(A.MES, '/', A.ANO)) MES_ANO,
	A.QTD_PEDIDO AS QTD_COMPRA
...
WHERE CAB.DTNEG BETWEEN DATEADD(YEAR,-1, '2023/06/01') AND '2023/06/30'
AND CAB.TIPMOV = 'V'
...
GROUP BY CAB.CODPARC, PAR.RAZAOSOCIAL,CAB.DTNEG,CAB.CODVEND, VEN.APELIDO, UF.UF

)A

GROUP BY A.UF, A.CODPARC, A.NOME_CLIENTE, A.APELIDO, A.QTD_PEDIDO
